...
function Login() {
  ...
  const onSuccess = (user) => {
    addToast(`Welcome ${user.displayName || user.email}`, "success");
    navigate("/");
  };
      ...
      <div className="authCard">
        ...
        <form className="createPostForm">
          ...
          <div className="auth-actions">
            <button onClick={loginEmail} disabled={submitting} className="btn-primary btn-full">Login</button>
            <Link to="/register" className="btn-primary btn-full">Register</Link>
